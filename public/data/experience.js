...
exports.experienceData = [
    {
        title: "Projet perso - Création d'une application dédiée aux OST/animations de Dokkan Battle",
        subtitle: "Création d'une application permettant d'écouter les OST et de jouer les animations Dokkan.",
        paragraphsDescription: [
            ...
            "Il permet de d'écouter les OST des personnages et des events/niveaux, ainsi que de jouer les animations associées",
            "Le site tourne avec Angular 19.2 en SSR pour la partie front, et Node Node / Express / Typescript / PostgreSQL pour le back.",
            "Afin de m'aider dans sa conception, je me suis créé quelques petits script en Python pour récupérer les informations dont j'ai besoin depuis la base de donnée de Dokkan, et les envoyer via mon API dans ma DB.",
            "En plus, je me sers aussi d'outils et de scripts permettant de convertir les fichiers extraits du jeu qui sont de base non lisible, en fichier lisible et utilisable.",
            "Le tout est hebergé sur un VPS que j'administre personellement.",
            "Attention ! Le site est loin d'être terminé et il y a des bugs. Mais il est déjà possible d'écouter la plupart des OST et de jouer les animations.",
        ],
    ...
    },
    {
        ...
        subtitle: "Création d'une application de tâche avec les nouveautés d'Angular 19",
        paragraphsDescription: [
    ...
    },
    {
        ...
        subtitle: "Création d'une application Web de gestion de tâches et d'équipes",
        paragraphsDescription: [
